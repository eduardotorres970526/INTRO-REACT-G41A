...
function App() {
  const tareasAnteriores = localStorage.getItem("tareas")
  ...
  // Efecto utilizado para convertir los datos almacenados en el localStorage a un objeto con JSON.parse
  useEffect(() => {
    if (tareasAnteriores) {
      setTareas(JSON.parse(tareasAnteriores));
    }
  },[])
